export LOCAL_CFLAGS = -DVERSION="ilianaw-$(shell git describe --abbrev=7 --dirty --always)" -DKALEIDOSCOPE_ENABLE_V1_PLUGIN_API=0 -DKALEIDOSCOPE_HIDADAPTOR_DISABLE_MOUSE
